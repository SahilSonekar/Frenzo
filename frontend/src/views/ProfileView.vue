    ...
    <div class="main-left col-span-1 h-fit sticky top-4">
      <div class="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-center rounded-lg">
        ...
        <div class="mt-6 space-y-2">
          <!-- 1. Send Friendship Request (Active) -->
          <button
          ...
          <!-- 2. Friendship Request Sent (Disabled) -->
          <button
            class="inline-block w-full py-2 px-3 bg-gray-500 text-xs text-white rounded-lg cursor-not-allowed opacity-75"
            disabled
            v-else-if="userStore.user.id !== user.id && !can_send_friendship_request">
            Request sent
          </button>
